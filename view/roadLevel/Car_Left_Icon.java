...
public class Car_Left_Icon extends GameSprite{
	private ImageIcon car;
	private int speed;

	public Car_Left_Icon(String orientation, Point carLoc, int speed){
		this.orientation = orientation;

		animationLoc = carLoc;
		if (orientation.equals("N") || orientation.equals("S")) {
			car = new ImageIcon("src/images/car_top_left.png");
			spriteHt = 106;
			spriteWd = 200;

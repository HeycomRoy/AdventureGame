...
public class Parser {
	...
	public static final String RS = "roadstripe";
    ...
    public static final String TAB = "    ";  // using four spaces 
     ...
     *  Loads the game
     */
    public static Game load(File f) throws FileNotFoundException{
        try {
    ...
    public static Game load(String gamefile) throws FileNotFoundException {
		try {
     ...
     */
    public static Game parseGame(Scanner s) {
    	try {
    	gobbleComment(s);
    	if (!openBlock(GAME, s)) {
        ...
        if (!closeBlock(GAME, s)) {
            ...
            return null;
        } else return new Game(status, levels, players, ids);
    ...
    public static Item parseItem(Scanner s, Set<Integer> ids) {
        ...
        switch (type) {
        	...
        	case TREASURE :
        		return new Treasure(id, TREASURE, null);
        	case CHEST :
